...
class ProviderTests(unittest.TestCase):
    ...
    def test_successful_save_updates_text_without_an_extra_read(self):
        ...
        self.payload.return_value = {"title": "same", "originalTitle": "same", "body": "new searchable text"}
        with patch.object(onenote, "images_complete", return_value=True), \
                patch.object(onenote, "patch_page", return_value=(204, "")), \
                patch.object(onenote, "graph_raw", side_effect=AssertionError("extra request")):
